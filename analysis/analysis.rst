...
Energy Density Analysis(バージョン2022.01以上)
-------------------------------------------------
...
エネルギー種別ごとに結果が記録されます。一行が1つの原子の結果に対応します。1カラム目が原子のID, 2カラム目が元素名, 3カラム目が電子密度, 4カラム目が電子の運動エネルギー, 5カラム目がハートリーエネルギー, 6カラム目が交換相関エネルギー, 7カラム目が局所エネルギー, 8カラム目非局所エネルギー, 8カラム目が原子核間のエネルギー, 9カラム目がpartial core correctionエネルギー, 10カラム目がすべての貢献分の和に対応します。
